...
// Fork divergence: writeSessionMessage is async here and notifyAgent attaches
// a .catch() to it, so the mock must resolve rather than return undefined.
vi.mock('../../session-manager.js', () => ({ writeSessionMessage: vi.fn().mockResolvedValue(undefined) }));
