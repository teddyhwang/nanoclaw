...
describe('cross-segment block assembly', () => {
  ...
  it('task runs assemble a deliberate split block and deliver it exactly once', async () => {
    seedDest();
    const TASK_ROUTING = {
      platformId: null,
      channelType: null,
